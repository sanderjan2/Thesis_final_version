...
public class k_ano {
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException {
		...
		// config.setGeneticAlgorithmDeterministic(true);
		...
		File f = new File("Results_anonymisation/Gen_Anony_"+ k +"_" + type + ".csv");
		
		if(!f.exists() && !f.isDirectory()) { 
			result.getOutput(false).save("Results_anonymisation/Gen_Anony_"+ k +"_" + type + ".csv", ',');
		}
